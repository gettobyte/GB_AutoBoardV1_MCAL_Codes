Creating summary for NVIC_SetPriority/3:
  Descriptor for parameter 0 IRQnD.8999
    not a candidate for splitting
  Descriptor for parameter 1 priorityD.9000
    not a candidate for splitting


Creating summary for NVIC_DisableIRQ/2:
  Descriptor for parameter 0 IRQnD.8996
    not a candidate for splitting


Creating summary for NVIC_EnableIRQ/1:
  Descriptor for parameter 0 IRQnD.8993
    not a candidate for splitting


Creating summary for NVIC_SetPriorityGrouping/0:
  Descriptor for parameter 0 PriorityGroupD.8990
    not a candidate for splitting
