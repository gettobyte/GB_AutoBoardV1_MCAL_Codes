...
__ZERO_TABLE/2 (__ZERO_TABLE) @05da8168
  Type: variable
  ...
  Varpool flags:
__INIT_TABLE/1 (__INIT_TABLE) @05da8120
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
init_data_bss/0 (init_data_bss) @05d3fb60
...
;; Function init_data_bss (init_data_bss, funcdef_no=0, decl_uid=5538, cgraph_uid=1, symbol_order=0)
...
init_data_bss ()
{
  ...
  *_7 = _8;
  ...
  # DEBUG BEGIN_STMT
  _9 = i_16 * 8;
  _10 = &MEM <uint32[<unknown>]> [(void *)&__ZERO_TABLE + 4B] + _9;
