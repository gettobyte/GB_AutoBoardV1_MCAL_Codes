...
Jump functions:
  ...
  Jump functions of caller  Clock_Ip_SetFircDivSelHseBConfigRegGpr/4:
    callsite  Clock_Ip_SetFircDivSelHseBConfigRegGpr/4 -> Clock_Ip_TimeoutExpired/7 : 
       no arg info
    callsite  Clock_Ip_SetFircDivSelHseBConfigRegGpr/4 -> Clock_Ip_StartTimeout/6 : 
       no arg info
  ...
  Jump functions of caller  Clock_Ip_SetCgmXDeDivStatWithoutPhase/1:
    callsite  Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 -> Clock_Ip_ReportClockErrors/12 : 
       no arg info
    callsite  Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 -> Clock_Ip_TimeoutExpired/7 : 
       no arg info
    callsite  Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 -> Clock_Ip_StartTimeout/6 : 
       no arg info
  Jump functions of caller  Clock_Ip_Callback_DividerEmpty/0:

 Propagating constants:

Not considering Clock_Ip_SetFircDivSelHseBConfigRegGpr/4 for cloning; -fipa-cp-clone disabled.
...
Clock_Ip_ReportClockErrors/12 (Clock_Ip_ReportClockErrors) @06180ee0
  Type: function
  ...
  Calls: 
Clock_Ip_apxCgm/11 (Clock_Ip_apxCgm) @06189558
  Type: variable
...
Clock_Ip_axFeatureExtensions/10 (Clock_Ip_axFeatureExtensions) @06189510
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_pxPll/9 (Clock_Ip_pxPll) @062b3ea0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_au8ClockFeatures/8 (Clock_Ip_au8ClockFeatures) @062b3e58
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_TimeoutExpired/7 (Clock_Ip_TimeoutExpired) @061809a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/6 (Clock_Ip_StartTimeout) @061808c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_axDividerCallbacks/5 (Clock_Ip_axDividerCallbacks) @062b35a0
...
Clock_Ip_SetFircDivSelHseBConfigRegGpr/4 (Clock_Ip_SetFircDivSelHseBConfigRegGpr) @061802a0
...
Clock_Ip_SetPllPlldvOdiv2Output/3 (Clock_Ip_SetPllPlldvOdiv2Output) @062b2c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_SetPllPll0divDeDivOutput/2 (Clock_Ip_SetPllPll0divDeDivOutput) @062b2ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 (Clock_Ip_SetCgmXDeDivStatWithoutPhase) @062b2b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
...
Clock_Ip_Callback_DividerEmpty/0 (Clock_Ip_Callback_DividerEmpty) @062b28c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_Callback_DividerEmpty (Clock_Ip_Callback_DividerEmpty, funcdef_no=0, decl_uid=6576, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_SetPllPll0divDeDivOutput (Clock_Ip_SetPllPll0divDeDivOutput, funcdef_no=2, decl_uid=6580, cgraph_uid=3, symbol_order=2)
...
;; Function Clock_Ip_SetPllPlldvOdiv2Output (Clock_Ip_SetPllPlldvOdiv2Output, funcdef_no=3, decl_uid=6582, cgraph_uid=4, symbol_order=3)
...
;; Function Clock_Ip_SetFircDivSelHseBConfigRegGpr (Clock_Ip_SetFircDivSelHseBConfigRegGpr, funcdef_no=4, decl_uid=6584, cgraph_uid=5, symbol_order=4)
...
;; Function Clock_Ip_SetCgmXDeDivStatWithoutPhase (Clock_Ip_SetCgmXDeDivStatWithoutPhase, funcdef_no=1, decl_uid=6578, cgraph_uid=2, symbol_order=1)
