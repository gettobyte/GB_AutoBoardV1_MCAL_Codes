Creating summary for Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1:
  Descriptor for parameter 0 ConfigD.6585
    by_ref with 0 pass throughs
        ...
        * Access to offset: 96, size: 32, type: const Clock_Ip_NameType, alias_ptr_type: <unnamed type> *, nonarg: 1, reverse: 0
        * Access to offset: 128, size: 32, type: const uint32, alias_ptr_type: long unsigned int *, nonarg: 1, reverse: 0
  Descriptor for parameter 1 CfgIndexD.6586
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6585
...
Creating summary for Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0:
  Descriptor for parameter 0 ConfigD.6581
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 IndexD.6582
    unused with 0 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6581
...
Summary for node Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1:
...
Summary for node Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0:
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 4, size_reached: 0, by_ref
  Descriptor for parameter 1:
...
Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0 disqualified because it cannot be made local.
Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1 disqualified because it cannot be made local.
...
PcfsRate.0/9 (PcfsRate) @06247240
...
AMax.1/8 (AMax) @062471f8
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
Clock_Ip_FreqIds/7 (Clock_Ip_FreqIds) @062471b0
  Type: variable
  ...
  Varpool flags:
Clock_Ip_pxConfig/6 (Clock_Ip_pxConfig) @06247168
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Hash.2/5 (Hash) @06247120
  ...
  Availability: available
  Varpool flags:
Clock_Ip_apxCgmPcfs/4 (Clock_Ip_apxCgmPcfs) @062470d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Clock_Ip_au8ClockFeatures/3 (Clock_Ip_au8ClockFeatures) @06247090
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axPcfsCallbacks/2 (Clock_Ip_axPcfsCallbacks) @0614d7e0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1 (Clock_Ip_CgmXPcfsSdurDivcDiveDivs) @0614cd20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/3 (read) Clock_Ip_apxCgmPcfs/4 (read) Clock_Ip_au8ClockFeatures/3 (read) Hash.2/5 (read) Hash.2/5 (write) Clock_Ip_pxConfig/6 (read) Clock_Ip_FreqIds/7 (read) AMax.1/8 (read) PcfsRate.0/9 (read) 
  Referring: Clock_Ip_axPcfsCallbacks/2 (addr) 
  Availability: available
  Function flags: count:178956971 (estimated locally) body optimize_size
  Called by: 
  Calls: 
Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0 (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty) @0614c620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
