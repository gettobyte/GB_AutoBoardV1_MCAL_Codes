...
Not considering Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1 for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0 for cloning; -fipa-cp-clone disabled.
...
;; Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty, funcdef_no=0, decl_uid=6577, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs (Clock_Ip_CgmXPcfsSdurDivcDiveDivs, funcdef_no=1, decl_uid=6580, cgraph_uid=2, symbol_order=1)
