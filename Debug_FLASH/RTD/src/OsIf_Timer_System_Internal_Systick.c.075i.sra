Creating summary for OsIf_Timer_System_Internal_GetElapsed/2:
  Descriptor for parameter 0 CurrentRefD.5702
...
Creating summary for OsIf_Timer_System_Internal_Init/0:
  Descriptor for parameter 0 SystemCounterFreqD.5696
    (locally) unused
    not a candidate for splitting
...
OsIf_Timer_System_Internal_GetElapsed/2 (OsIf_Timer_System_Internal_GetElapsed) @05da8460
  ...
  Called by: 
  Calls: 
OsIf_Timer_System_Internal_GetCounter/1 (OsIf_Timer_System_Internal_GetCounter) @05da81c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
OsIf_Timer_System_Internal_Init/0 (OsIf_Timer_System_Internal_Init) @05d998c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
