...
Not considering OsIf_MicrosToTicks/9 for cloning; -fipa-cp-clone disabled.
Not considering OsIf_SetTimerFrequency/8 for cloning; -fipa-cp-clone disabled.
Not considering OsIf_GetElapsed/7 for cloning; -fipa-cp-clone disabled.
Not considering OsIf_GetCounter/6 for cloning; -fipa-cp-clone disabled.
Not considering OsIf_Init/5 for cloning; -fipa-cp-clone disabled.
