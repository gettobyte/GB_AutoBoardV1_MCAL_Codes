...
Creating summary for Clock_Ip_TimeoutExpired/25:
  Descriptor for parameter 0 StartTimeInOutD.6778
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 1 ElapsedTimeInOutD.6779
    not a candidate
  Descriptor for parameter 2 TimeoutTicksD.6780
    not a candidate
----------------------------------------
  Descriptor for parameter 0 StartTimeInOutD.6778
    (locally) unused
...
Creating summary for Clock_Ip_StartTimeout/24:
  Descriptor for parameter 0 StartTimeOutD.6772
    not a candidate for splitting
  Descriptor for parameter 1 ElapsedTimeOutD.6773
    not a candidate for splitting
  Descriptor for parameter 2 TimeoutTicksOutD.6774
    not a candidate for splitting
  Descriptor for parameter 3 TimeoutUsD.6775
    (locally) unused
    not a candidate for splitting


Creating summary for Clock_Ip_ReportClockErrors/23:
  Descriptor for parameter 0 ErrorD.6768
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 ClockNameD.6769
    (locally) unused
    not a candidate for splitting
...
Creating summary for Clock_Ip_InitClock/9:
  Descriptor for parameter 0 ConfigD.6652
    not a candidate for splitting


Creating summary for Clock_Ip_Init/8:
  Descriptor for parameter 0 ConfigD.6647
    unused with 1 call_uses
    by_ref with 1 pass throughs
----------------------------------------
  Descriptor for parameter 0 ConfigD.6647
...
Creating summary for Clock_Ip_ResetClockConfiguration/7:
  Descriptor for parameter 0 ConfigD.6630
    not a candidate for splitting
...
Creating summary for Clock_Ip_UpdateDriverContext/5:
  Descriptor for parameter 0 ConfigD.6616
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6616
    not a candidate for splitting
...
Creating summary for Clock_Ip_NotificatonsEmptyCallback/4:
  Descriptor for parameter 0 NotificationD.6612
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 ClockNameD.6613
    (locally) unused
    not a candidate for splitting
...
Clock_Ip_DistributePll.part.0 ()
{
  ...
  int _20;
  unsigned char _21;
  void (*<T6b5>) (const struct Clock_Ip_GateConfigType *) _23;
  ...
  int _32;
  unsigned char _33;
  void (*<T6ca>) (const struct Clock_Ip_CmuConfigType *) _35;
...
Clock_Ip_GetPllStatus.part.0 ()
{
  ...
  int _4;
  unsigned char _5;
  Clock_Ip_DfsStatusType (*<T68b>) (Clock_Ip_NameType) _7;
  unsigned char _10;
...
{
  void (*<T53b>) (Clock_Ip_NotificationType, Clock_Ip_NameType) Clock_Ip_pfkNotificationsCallback.5_1;
  void (*<T53b>) (Clock_Ip_NotificationType, Clock_Ip_NameType) Clock_Ip_pfkNotificationsCallback.6_2;
  void (*<T53b>) (Clock_Ip_NotificationType, Clock_Ip_NameType) Clock_Ip_pfkNotificationsCallback.7_3;
  void (*<T53b>) (Clock_Ip_NotificationType, Clock_Ip_NameType) Clock_Ip_pfkNotificationsCallback.8_4;

  <bb 2> [local count: 1073741824]:
  # DEBUG BEGIN_STMT
  Clock_Ip_pfkNotificationsCallback.5_1 = Clock_Ip_pfkNotificationsCallback;
  Clock_Ip_pfkNotificationsCallback.5_1 (4, 143);
  # DEBUG BEGIN_STMT
  Clock_Ip_SetRamWaitStates ();
  # DEBUG BEGIN_STMT
  Clock_Ip_pfkNotificationsCallback.6_2 = Clock_Ip_pfkNotificationsCallback;
  Clock_Ip_pfkNotificationsCallback.6_2 (5, 143);
  # DEBUG BEGIN_STMT
  Clock_Ip_pfkNotificationsCallback.7_3 = Clock_Ip_pfkNotificationsCallback;
  Clock_Ip_pfkNotificationsCallback.7_3 (6, 143);
  # DEBUG BEGIN_STMT
  Clock_Ip_SetFlashWaitStates ();
  # DEBUG BEGIN_STMT
  Clock_Ip_pfkNotificationsCallback.8_4 = Clock_Ip_pfkNotificationsCallback;
  Clock_Ip_pfkNotificationsCallback.8_4 (7, 143);
  return;
...
Clock_Ip_ResetClockConfiguration (const struct Clock_Ip_ClockConfigType * Config)
{
  ...
  int _13;
  unsigned char _14;
  void (*<T685>) (const struct Clock_Ip_FracDivConfigType *) _15;
  ...
  int _21;
  unsigned char _22;
  void (*<T696>) (const struct Clock_Ip_PllConfigType *) _23;
  ...
  int _29;
  unsigned char _30;
  void (*<T660>) (const struct Clock_Ip_XoscConfigType *) _31;
...
Clock_Ip_CallEmptyCallbacks ()
{
  ...
  void (*<T6c5>) (const struct Clock_Ip_CmuConfigType *, uint32) _2;
  void (*<T654>) (Clock_Ip_NameType) _3;
  void (*<T654>) (Clock_Ip_NameType) _4;
  Clock_Ip_CmuStatusType (*<T6cf>) (Clock_Ip_NameType) _5;
  void (*<T66e>) (const struct Clock_Ip_DividerConfigType *) _6;
  void (*<T679>) (const struct Clock_Ip_DividerTriggerConfigType *) _7;
  void (*<T660>) (const struct Clock_Ip_XoscConfigType *) _8;
  void (*<T685>) (const struct Clock_Ip_FracDivConfigType *) _9;
  Clock_Ip_DfsStatusType (*<T68b>) (Clock_Ip_NameType) _10;
  void (*<T6b5>) (const struct Clock_Ip_GateConfigType *) _11;
  void (*<T6ba>) (Clock_Ip_NameType, boolean) _12;
  void (*<T651>) (const struct Clock_Ip_IrcoscConfigType *) _13;
  void (*<T696>) (const struct Clock_Ip_PllConfigType *) _14;
  Clock_Ip_PllStatusReturnType (*<T69c>) (Clock_Ip_NameType) _15;
  void (*<T6a9>) (const struct Clock_Ip_SelectorConfigType *) _16;
  void (*<T6db>) (const struct Clock_Ip_PcfsConfigType *, uint32) _17;
