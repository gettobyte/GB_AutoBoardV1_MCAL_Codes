Creating summary for Clock_Ip_EnablePllRdivMfiMfnOdiv2SdmenSsscgbypSpreadctlStepnoStepsize/6:
  Descriptor for parameter 0 ConfigD.6619
...
Creating summary for Clock_Ip_CompletePllRdivMfiMfnOdiv2SdmenSsscgbypSpreadctlStepnoStepsize/5:
  Descriptor for parameter 0 PllNameD.6607
    not a candidate for splitting
...
Creating summary for Clock_Ip_SetPllRdivMfiMfnOdiv2SdmenSsscgbypSpreadctlStepnoStepsize/4:
  Descriptor for parameter 0 ConfigD.6602
    by_ref with 0 pass throughs
        ...
        * Access to offset: 144, size: 16, type: const uint16, alias_ptr_type: short unsigned int *, nonarg: 1, reverse: 0
        * Access to offset: 160, size: 8, type: const uint8, alias_ptr_type: unsigned char *, nonarg: 1, reverse: 0
        * Access to offset: 168, size: 8, type: const uint8, alias_ptr_type: unsigned char *, nonarg: 1, reverse: 0
        * Access to offset: 176, size: 8, type: const uint8, alias_ptr_type: unsigned char *, nonarg: 1, reverse: 0
        * Access to offset: 192, size: 16, type: const uint16, alias_ptr_type: short unsigned int *, nonarg: 1, reverse: 0
        * Access to offset: 208, size: 16, type: const uint16, alias_ptr_type: short unsigned int *, nonarg: 1, reverse: 0
        * Access to offset: 224, size: 8, type: const uint8, alias_ptr_type: unsigned char *, nonarg: 1, reverse: 0
----------------------------------------
  Descriptor for parameter 0 ConfigD.6602
    not a candidate for splitting
...
Creating summary for Clock_Ip_CallbackPllEmptyDisable/2:
  Descriptor for parameter 0 PllNameD.6595
    (locally) unused
    not a candidate for splitting


Creating summary for Clock_Ip_CallbackPllEmptyComplete/1:
  Descriptor for parameter 0 PllNameD.6592
    (locally) unused
    not a candidate for splitting


Creating summary for Clock_Ip_CallbackPllEmpty/0:
  Descriptor for parameter 0 ConfigD.6589
