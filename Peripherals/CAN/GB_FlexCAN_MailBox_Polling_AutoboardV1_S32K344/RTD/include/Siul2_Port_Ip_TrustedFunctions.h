...
==================================================================================================*/
    ...
    /* Check if header file and Siul2_Port_Ip_TrustedFunctions.h file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of StandardTypes.h and Siul2_Port_Ip_TrustedFunctions.h are different"
    #endif
#endif
