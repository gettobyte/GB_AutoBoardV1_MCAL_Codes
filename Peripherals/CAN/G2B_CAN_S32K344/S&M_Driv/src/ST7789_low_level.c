...
static void TestDelay(uint32 delay)
{
 ...
 extern const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_3; \

//PTE15
#define gb_ST7789_DC_pin_low()  Dio_WriteChannel(DioConf_DioChannel_ST7789_DC, 0);
#define gb_ST7789_DC_pin_high() Dio_WriteChannel(DioConf_DioChannel_ST7789_DC, 1);

 //PTB12
#define gb_ST7789_CS_pin_low()  Dio_WriteChannel(DioConf_DioChannel_ST7789_CS, 0);
#define gb_ST7789_CS_pin_high() Dio_WriteChannel(DioConf_DioChannel_ST7789_CS, 1);

 //PTA18
#define gb_ST7789_reset_pin_low()  Dio_WriteChannel(DioConf_DioChannel_ST7789_Reset, 0);
#define gb_ST7789_reset_pin_high() Dio_WriteChannel(DioConf_DioChannel_ST7789_Reset, 1);
...
void ST7789_DrawImage(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint8_t *data)
{
	...
	for (uint16_t j =1; j<(NoOfRounds-1); j++)
	 {
		{
