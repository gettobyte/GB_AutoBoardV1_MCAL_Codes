...
#endif
#if defined(CLOCK_IP_HAS_GMAC_MII_RGMII_RX_CLK)
static uint32 Clock_Ip_Get_gmac_mii_rgmii_rx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC_MII_RMII_RGMII_TX_CLK)
static uint32 Clock_Ip_Get_gmac_mii_rmii_rgmii_tx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC0_MII_RGMII_RX_CLK)
static uint32 Clock_Ip_Get_gmac0_mii_rgmii_rx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC0_MII_RMII_RGMII_TX_CLK)
static uint32 Clock_Ip_Get_gmac0_mii_rmii_rgmii_tx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC1_MII_RGMII_RX_CLK)
static uint32 Clock_Ip_Get_gmac1_mii_rgmii_rx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC1_MII_RMII_RGMII_TX_CLK)
static uint32 Clock_Ip_Get_gmac1_mii_rmii_rgmii_tx_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_LFAST_REF_EXT_CLK)
...
static uint32 Clock_Ip_Get_GMAC_TX_CLK_Frequency(void);
#endif
#if defined(CLOCK_IP_HAS_GMAC_RX_CLK)
static uint32 Clock_Ip_Get_GMAC_RX_CLK_Frequency(void);
#endif
...
static uint32 Clock_Ip_Get_USDHC_PER_CLK_Frequency(void);
#endif
