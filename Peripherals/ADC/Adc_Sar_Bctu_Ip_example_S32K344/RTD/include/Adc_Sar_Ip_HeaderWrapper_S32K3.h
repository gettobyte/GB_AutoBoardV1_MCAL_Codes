...
#define ADC_SAR_IP_SW_MAJOR_VERSION_HEADERWRAPPER_S32K3               4
...
#define ADC_SAR_IP_SELFTEST_FULL_CLK         (0U)
...
#define FEATURE_ADC_FEAT_AVAIL_BITMAP   {0x0000000FU, /* Adc HW Unit 0 */ \
                                         ...
                                         0x0000000EU, /* Adc HW Unit 2 */ \
                                         0x0000000EU, /* Adc HW Unit 3 */ \
                                         0x0000000EU, /* Adc HW Unit 4 */ \
                                         0x0000000EU, /* Adc HW Unit 5 */ \
                                         0x0000000EU, /* Adc HW Unit 6 */ \
                                        }
...
#define ADC_SAR_IP_TEMPSENSE_CONVDATA_MAX      ((1UL << ADC_SAR_IP_RESULT_RESOLUTION) - 1UL)
...
#define ADC_SAR_IP_TEMPSENSE_MULTIPLIER        (10000U)  /* preserve all 4 fractional digits of the final result in Q11.4 format */
