...
/* For GM Firmware the Key Catalog has to be in-sync with catalog used internally */
#if (HSE_FWTYPE == 8U)
/** @brief    HSE RAM key catalog configuration*/
#define  HSE_NVM_KEY_CATALOG_CFG  \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE, 12U, HSE_KEY128_BITS, {0U, 0U}},           /* MASTER_ECU_KEY, BOOT_MAC_KEY, KEY_1 to KEY_10 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE, 10U, HSE_KEY128_BITS, {0U, 0U}},           /* KEY_11 to KEY_20 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE, 10U, HSE_KEY128_BITS, {0U, 0U}},           /* KEY_21 to KEY_30 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE, 10U, HSE_KEY128_BITS, {0U, 0U}},           /* KEY_31 to KEY_40 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE, 10U, HSE_KEY128_BITS, {0U, 0U}},           /* KEY_41 to KEY_50 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PAIR, 4U, HSE_KEY521_BITS, {0U, 0U}},       /* 4 ECC KEY PAIR */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PUB, 4U, HSE_KEY521_BITS, {0U, 0U}},        /* 4 ECC KEY PUB KEY */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PUB_EXT, 4U, HSE_KEY521_BITS, {0U, 0U}},    /* 4 External ECC PUB KEY */ \
        { 0U,              0U,                 0U,               0U,  0U,              {0U, 0U}}

/** @brief    HSE RAM key catalog configuration*/
#define  HSE_RAM_KEY_CATALOG_CFG  \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_SHE,  1U, HSE_KEY128_BITS, {0U, 0U}},            /* KEY_RAM */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PAIR, 4U, HSE_KEY521_BITS, {0U, 0U}},        /* 4 ECC KEY PAIR */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PUB, 4U, HSE_KEY521_BITS, {0U, 0U}},         /* 4 ECC KEY PUB KEY */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PUB_EXT, 4U, HSE_KEY521_BITS, {0U, 0U}},     /* 4 External ECC PUB KEY */ \
        {0U,               0U,                0U,                0U, 0U,  {0U, 0U}}

/** @brief    HSE RAM key catalog configuration*/
#define  HSE_RAM_ECC_KEY_CATALOG_CFG  \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_SHE,  1U, HSE_KEY128_BITS, {0U, 0U}},            /* KEY_RAM */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PAIR, 4U, HSE_KEY521_BITS, {0U, 0U}},        /* 4 ECC KEY PAIR */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PUB, 4U, HSE_KEY521_BITS, {0U, 0U}},         /* 4 ECC KEY PUB KEY */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY, HSE_KEY_TYPE_ECC_PUB_EXT, 4U, HSE_KEY521_BITS, {0U, 0U}},     /* 4 External ECC PUB KEY */ \
...
/** @brief    Wrappers for classic DH key definitions.
 *            If classic DH is not enabled, transform the classic DH key slots into AES key slots,
 *            so that the subsequent key slot indices are preserved
 *            */
#ifdef HSE_SPT_CLASSIC_DH
    #define WRP_KEY_TYPE_DH_PAIR    HSE_KEY_TYPE_DH_PAIR
    #define WRP_KEY_TYPE_DH_PUB     HSE_KEY_TYPE_DH_PUB
    #define WRP_DH_KEY_SIZE         HSE_KEY1024_BITS
#else
    #define WRP_KEY_TYPE_DH_PAIR    HSE_KEY_TYPE_AES
    #define WRP_KEY_TYPE_DH_PUB     HSE_KEY_TYPE_AES
    #define WRP_DH_KEY_SIZE         HSE_KEY128_BITS
#endif
...
#define  HSE_RAM_KEY_CATALOG_CFG  \
        ...
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,   WRP_KEY_TYPE_ECC_PUB,        4U,        WRP_ECC_KEY_SIZE }, \
        ...
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,   WRP_KEY_TYPE_DH_PAIR,        2U,        WRP_DH_KEY_SIZE }, \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,   WRP_KEY_TYPE_DH_PUB,         1U,        WRP_DH_KEY_SIZE }, \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,   WRP_KEY_TYPE_ECC_PUB_EXT,    1U,        WRP_ECC_KEY_SIZE }, \
        {0U,               0U,                  0U,                          0U,         0U  }
...
#define  HSE_SHE_NVM_KEY_CATALOG_CFG  \
        ...
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE,          10U  ,     HSE_KEY128_BITS }, /* KEY_31 to KEY_40 */ \
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE,          10U  ,     HSE_KEY128_BITS }, /* KEY_41 to KEY_50 */ \
        { 0U,              0U,                            0U   ,          0U   ,     0U  }
...
#define RAM_AES128_KEY1         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 0, 1)
...
#define RAM_AES256_KEY0         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 1, 0)
#define RAM_AES256_KEY1         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 1, 1)
...
/** @brief HMAC RAM KEYS */
#define RAM_HMAC_KEY0           GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 2, 0)
#define RAM_HMAC_KEY1           GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 2, 1)
...
#define RAM_SHARED_SECRET2048_KEY1      GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 8, 1)
#if 0
...
#define NVM_AES256_KEY2         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 2)
