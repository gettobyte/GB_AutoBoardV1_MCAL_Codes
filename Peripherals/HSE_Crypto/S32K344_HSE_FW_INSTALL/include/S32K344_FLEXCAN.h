...
#define CAN_0_BASE                               (0x40304000u)
/** Peripheral CAN_0 base pointer */
#define CAN_0                                    ((FLEXCAN_Type *)CAN_0_BASE)
/** Peripheral CAN_1 base address */
#define CAN_1_BASE                               (0x40308000u)
/** Peripheral CAN_1 base pointer */
#define CAN_1                                    ((FLEXCAN_Type *)CAN_1_BASE)
/** Peripheral CAN_2 base address */
#define CAN_2_BASE                               (0x4030C000u)
/** Peripheral CAN_2 base pointer */
#define CAN_2                                    ((FLEXCAN_Type *)CAN_2_BASE)
/** Peripheral CAN_3 base address */
#define CAN_3_BASE                               (0x40310000u)
/** Peripheral CAN_3 base pointer */
#define CAN_3                                    ((FLEXCAN_Type *)CAN_3_BASE)
/** Peripheral CAN_4 base address */
#define CAN_4_BASE                               (0x40314000u)
/** Peripheral CAN_4 base pointer */
#define CAN_4                                    ((FLEXCAN_Type *)CAN_4_BASE)
/** Peripheral CAN_5 base address */
#define CAN_5_BASE                               (0x40318000u)
/** Peripheral CAN_5 base pointer */
#define CAN_5                                    ((FLEXCAN_Type *)CAN_5_BASE)
/** Array initializer of FLEXCAN peripheral base addresses */
#define FLEXCAN_BASE_ADDRS                       { CAN_0_BASE, CAN_1_BASE, CAN_2_BASE, CAN_3_BASE, CAN_4_BASE, CAN_5_BASE }
/** Array initializer of FLEXCAN peripheral base pointers */
#define FLEXCAN_BASE_PTRS                        { CAN_0, CAN_1, CAN_2, CAN_3, CAN_4, CAN_5 }
