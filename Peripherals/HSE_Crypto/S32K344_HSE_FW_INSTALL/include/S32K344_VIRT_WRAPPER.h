...
#define VIRT_WRAPPER_REG_COUNT                    32u
#define VIRT_WRAPPER_REG_32_COUNT                 32u
#define VIRT_WRAPPER_REG_64_COUNT                 1u
#define VIRT_WRAPPER_REG_65_COUNT                 1u

/** VIRT_WRAPPER - Register Layout Typedef */
typedef struct {
  __IO uint32_t A[VIRT_WRAPPER_REG_COUNT];         /**< Parameter_n Register, array offset: 0x0, array step: 0x4 */
  __IO uint32_t REG_B[VIRT_WRAPPER_REG_32_COUNT];  /**< Parameter_n Register, array offset: 0x80, array step: 0x4 */
  __IO uint32_t REG_C[VIRT_WRAPPER_REG_64_COUNT];  /**< Parameter_n Register, array offset: 0x100, array step: 0x4 */
  __IO uint32_t REG_D[VIRT_WRAPPER_REG_65_COUNT];  /**< Parameter_n Register, array offset: 0x104, array step: 0x4 */
...
/*! @name A - Parameter_n Register */
/*! @{ */
#define VIRT_WRAPPER_A_PAD_0_MASK                (0x3U)
#define VIRT_WRAPPER_A_PAD_0_SHIFT               (0U)
#define VIRT_WRAPPER_A_PAD_0_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_0(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_0_SHIFT)) & VIRT_WRAPPER_A_PAD_0_MASK)
#define VIRT_WRAPPER_A_PAD_1_MASK                (0xCU)
#define VIRT_WRAPPER_A_PAD_1_SHIFT               (2U)
#define VIRT_WRAPPER_A_PAD_1_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_1(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_1_SHIFT)) & VIRT_WRAPPER_A_PAD_1_MASK)
#define VIRT_WRAPPER_A_PAD_2_MASK                (0x30U)
#define VIRT_WRAPPER_A_PAD_2_SHIFT               (4U)
#define VIRT_WRAPPER_A_PAD_2_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_2(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_2_SHIFT)) & VIRT_WRAPPER_A_PAD_2_MASK)
#define VIRT_WRAPPER_A_PAD_3_MASK                (0xC0U)
#define VIRT_WRAPPER_A_PAD_3_SHIFT               (6U)
#define VIRT_WRAPPER_A_PAD_3_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_3(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_3_SHIFT)) & VIRT_WRAPPER_A_PAD_3_MASK)
#define VIRT_WRAPPER_A_PAD_4_MASK                (0x300U)
#define VIRT_WRAPPER_A_PAD_4_SHIFT               (8U)
#define VIRT_WRAPPER_A_PAD_4_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_4(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_4_SHIFT)) & VIRT_WRAPPER_A_PAD_4_MASK)
#define VIRT_WRAPPER_A_PAD_5_MASK                (0xC00U)
#define VIRT_WRAPPER_A_PAD_5_SHIFT               (10U)
#define VIRT_WRAPPER_A_PAD_5_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_5(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_5_SHIFT)) & VIRT_WRAPPER_A_PAD_5_MASK)
#define VIRT_WRAPPER_A_PAD_6_MASK                (0x3000U)
#define VIRT_WRAPPER_A_PAD_6_SHIFT               (12U)
#define VIRT_WRAPPER_A_PAD_6_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_6(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_6_SHIFT)) & VIRT_WRAPPER_A_PAD_6_MASK)
#define VIRT_WRAPPER_A_PAD_7_MASK                (0xC000U)
#define VIRT_WRAPPER_A_PAD_7_SHIFT               (14U)
#define VIRT_WRAPPER_A_PAD_7_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_7(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_7_SHIFT)) & VIRT_WRAPPER_A_PAD_7_MASK)
#define VIRT_WRAPPER_A_PAD_8_MASK                (0x30000U)
#define VIRT_WRAPPER_A_PAD_8_SHIFT               (16U)
#define VIRT_WRAPPER_A_PAD_8_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_8(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_8_SHIFT)) & VIRT_WRAPPER_A_PAD_8_MASK)
#define VIRT_WRAPPER_A_PAD_9_MASK                (0xC0000U)
#define VIRT_WRAPPER_A_PAD_9_SHIFT               (18U)
#define VIRT_WRAPPER_A_PAD_9_WIDTH               (2U)
#define VIRT_WRAPPER_A_PAD_9(x)                  (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_9_SHIFT)) & VIRT_WRAPPER_A_PAD_9_MASK)
#define VIRT_WRAPPER_A_PAD_10_MASK               (0x300000U)
#define VIRT_WRAPPER_A_PAD_10_SHIFT              (20U)
#define VIRT_WRAPPER_A_PAD_10_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_10(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_10_SHIFT)) & VIRT_WRAPPER_A_PAD_10_MASK)
#define VIRT_WRAPPER_A_PAD_11_MASK               (0xC00000U)
#define VIRT_WRAPPER_A_PAD_11_SHIFT              (22U)
#define VIRT_WRAPPER_A_PAD_11_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_11(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_11_SHIFT)) & VIRT_WRAPPER_A_PAD_11_MASK)
#define VIRT_WRAPPER_A_PAD_12_MASK               (0x3000000U)
#define VIRT_WRAPPER_A_PAD_12_SHIFT              (24U)
#define VIRT_WRAPPER_A_PAD_12_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_12(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_12_SHIFT)) & VIRT_WRAPPER_A_PAD_12_MASK)
#define VIRT_WRAPPER_A_PAD_13_MASK               (0xC000000U)
#define VIRT_WRAPPER_A_PAD_13_SHIFT              (26U)
#define VIRT_WRAPPER_A_PAD_13_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_13(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_13_SHIFT)) & VIRT_WRAPPER_A_PAD_13_MASK)
#define VIRT_WRAPPER_A_PAD_14_MASK               (0x30000000U)
#define VIRT_WRAPPER_A_PAD_14_SHIFT              (28U)
#define VIRT_WRAPPER_A_PAD_14_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_14(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_14_SHIFT)) & VIRT_WRAPPER_A_PAD_14_MASK)
#define VIRT_WRAPPER_A_PAD_15_MASK               (0xC0000000U)
#define VIRT_WRAPPER_A_PAD_15_SHIFT              (30U)
#define VIRT_WRAPPER_A_PAD_15_WIDTH              (2U)
#define VIRT_WRAPPER_A_PAD_15(x)                 (((uint32_t)(((uint32_t)(x)) << VIRT_WRAPPER_A_PAD_15_SHIFT)) & VIRT_WRAPPER_A_PAD_15_MASK)
/*! @} */
