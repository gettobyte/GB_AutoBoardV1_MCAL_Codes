...
#define MC_RGM_FES_SWT1_RST_MASK                 (0x80U)
#define MC_RGM_FES_SWT1_RST_SHIFT                (7U)
#define MC_RGM_FES_SWT1_RST_WIDTH                (1U)
#define MC_RGM_FES_SWT1_RST(x)                   (((uint32_t)(((uint32_t)(x)) << MC_RGM_FES_SWT1_RST_SHIFT)) & MC_RGM_FES_SWT1_RST_MASK)
...
#define MC_RGM_FERD_D_SWT1_RST_MASK              (0x80U)
#define MC_RGM_FERD_D_SWT1_RST_SHIFT             (7U)
#define MC_RGM_FERD_D_SWT1_RST_WIDTH             (1U)
#define MC_RGM_FERD_D_SWT1_RST(x)                (((uint32_t)(((uint32_t)(x)) << MC_RGM_FERD_D_SWT1_RST_SHIFT)) & MC_RGM_FERD_D_SWT1_RST_MASK)
...
#define MC_RGM_FBRE_BE_SWT1_RST_MASK             (0x80U)
#define MC_RGM_FBRE_BE_SWT1_RST_SHIFT            (7U)
#define MC_RGM_FBRE_BE_SWT1_RST_WIDTH            (1U)
#define MC_RGM_FBRE_BE_SWT1_RST(x)               (((uint32_t)(((uint32_t)(x)) << MC_RGM_FBRE_BE_SWT1_RST_SHIFT)) & MC_RGM_FBRE_BE_SWT1_RST_MASK)
