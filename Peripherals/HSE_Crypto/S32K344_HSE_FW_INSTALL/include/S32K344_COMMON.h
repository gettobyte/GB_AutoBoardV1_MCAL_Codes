...
typedef enum {
  ...
  HSE_B_0_IRQn                 = 192,              /**< ORed TX interrupt to MU-0 */
  HSE_B_1_IRQn                 = 193,              /**< ORed RX interrupt to MU-0 */
  HSE_B_2_IRQn                 = 194,              /**< ORed general purpose interrupt request to MU-0 */
  HSE_B_3_IRQn                 = 195,              /**< ORed TX interrupt to MU-1 */
  HSE_B_4_IRQn                 = 196,              /**< ORed RX interrupt to MU-1 */
  HSE_B_5_IRQn                 = 197,              /**< ORed general purpose interrupt request to MU-1 */
