...
#define MU_INSTANCE_COUNT                        (4u)

/* MU - Peripheral instance base addresses */
/** Peripheral MU_0__MUB base address */
#define MU_0__MUB_BASE                           (0x4038C000u)
/** Peripheral MU_0__MUB base pointer */
#define MU_0__MUB                                ((MU_Type *)MU_0__MUB_BASE)
/** Peripheral MU_1__MUB base address */
#define MU_1__MUB_BASE                           (0x404EC000u)
/** Peripheral MU_1__MUB base pointer */
#define MU_1__MUB                                ((MU_Type *)MU_1__MUB_BASE)
/** Peripheral MU_2__MUA base address */
#define MU_2__MUA_BASE                           (0x400B8000u)
/** Peripheral MU_2__MUA base pointer */
#define MU_2__MUA                                ((MU_Type *)MU_2__MUA_BASE)
/** Peripheral MU_2__MUB base address */
#define MU_2__MUB_BASE                           (0x400BC000u)
/** Peripheral MU_2__MUB base pointer */
#define MU_2__MUB                                ((MU_Type *)MU_2__MUB_BASE)
/** Array initializer of MU peripheral base addresses */
#define MU_BASE_ADDRS                            { MU_0__MUB_BASE, MU_1__MUB_BASE, MU_2__MUA_BASE, MU_2__MUB_BASE }
/** Array initializer of MU peripheral base pointers */
#define MU_BASE_PTRS                             { MU_0__MUB, MU_1__MUB, MU_2__MUA, MU_2__MUB }
