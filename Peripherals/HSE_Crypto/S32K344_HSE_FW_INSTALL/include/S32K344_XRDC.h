...
typedef struct {
  ...
  struct {                                         /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word0, array offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word1, array offset: 0x404, array step: 0x10 */
    uint8_t RESERVED_0[4];
    __O  uint32_t DERR_W3;                           /**< Domain Error Word3, array offset: 0x40C, array step: 0x10 */
  ...
  __IO uint32_t MDA_W0_4_DFMT0;                    /**< Master Domain Assignment, offset: 0x880 */
  uint8_t RESERVED_11[28];
  __IO uint32_t MDA_W0_5_DFMT1;                    /**< Master Domain Assignment, offset: 0x8A0 */
  uint8_t RESERVED_12[1884];
  struct {                                         /* offset: 0x1000, array step: 0x400 */
    struct {                                         /* offset: 0x1000, array step: index*0x400, index2*0x8 */
      __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control, array offset: 0x1000, array step: index*0x400, index2*0x8 */
      __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control, array offset: 0x1004, array step: index*0x400, index2*0x8 */
    } PDACN[XRDC_PDAC_SLOT_PDACN_COUNT];
    uint8_t RESERVED_0[152];
  } PDAC_SLOT[XRDC_PDAC_SLOT_COUNT];
  uint8_t RESERVED_13[1024];
  struct {                                         /* offset: 0x2000, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W0;                      /**< Memory Region Descriptor, array offset: 0x2000, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W1;                      /**< Memory Region Descriptor, array offset: 0x2004, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W2;                      /**< Memory Region Descriptor, array offset: 0x2008, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W3;                      /**< Memory Region Descriptor, array offset: 0x200C, array step: index*0x200, index2*0x20 */
...
/*! @name DERR_W0 - Domain Error Word0 */
/*! @{ */
...
/*! @name DERR_W1 - Domain Error Word1 */
/*! @{ */
...
/*! @name DERR_W3 - Domain Error Word3 */
/*! @{ */
...
/*! @name MDA_W0_4_DFMT0 - Master Domain Assignment */
/*! @{ */
#define XRDC_MDA_W0_4_DFMT0_DID_MASK             (0x3U)
#define XRDC_MDA_W0_4_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_4_DFMT0_DID_WIDTH            (2U)
#define XRDC_MDA_W0_4_DFMT0_DID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_DID_SHIFT)) & XRDC_MDA_W0_4_DFMT0_DID_MASK)
#define XRDC_MDA_W0_4_DFMT0_DIDS_MASK            (0x30U)
#define XRDC_MDA_W0_4_DFMT0_DIDS_SHIFT           (4U)
#define XRDC_MDA_W0_4_DFMT0_DIDS_WIDTH           (2U)
#define XRDC_MDA_W0_4_DFMT0_DIDS(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_DIDS_SHIFT)) & XRDC_MDA_W0_4_DFMT0_DIDS_MASK)
#define XRDC_MDA_W0_4_DFMT0_PE_MASK              (0xC0U)
#define XRDC_MDA_W0_4_DFMT0_PE_SHIFT             (6U)
#define XRDC_MDA_W0_4_DFMT0_PE_WIDTH             (2U)
#define XRDC_MDA_W0_4_DFMT0_PE(x)                (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_PE_SHIFT)) & XRDC_MDA_W0_4_DFMT0_PE_MASK)
#define XRDC_MDA_W0_4_DFMT0_PIDM_MASK            (0x3F00U)
#define XRDC_MDA_W0_4_DFMT0_PIDM_SHIFT           (8U)
#define XRDC_MDA_W0_4_DFMT0_PIDM_WIDTH           (6U)
#define XRDC_MDA_W0_4_DFMT0_PIDM(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_PIDM_SHIFT)) & XRDC_MDA_W0_4_DFMT0_PIDM_MASK)
#define XRDC_MDA_W0_4_DFMT0_PID_MASK             (0x3F0000U)
#define XRDC_MDA_W0_4_DFMT0_PID_SHIFT            (16U)
#define XRDC_MDA_W0_4_DFMT0_PID_WIDTH            (6U)
#define XRDC_MDA_W0_4_DFMT0_PID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_PID_SHIFT)) & XRDC_MDA_W0_4_DFMT0_PID_MASK)
#define XRDC_MDA_W0_4_DFMT0_DFMT_MASK            (0x20000000U)
#define XRDC_MDA_W0_4_DFMT0_DFMT_SHIFT           (29U)
#define XRDC_MDA_W0_4_DFMT0_DFMT_WIDTH           (1U)
#define XRDC_MDA_W0_4_DFMT0_DFMT(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_DFMT_SHIFT)) & XRDC_MDA_W0_4_DFMT0_DFMT_MASK)
#define XRDC_MDA_W0_4_DFMT0_LK1_MASK             (0x40000000U)
#define XRDC_MDA_W0_4_DFMT0_LK1_SHIFT            (30U)
#define XRDC_MDA_W0_4_DFMT0_LK1_WIDTH            (1U)
#define XRDC_MDA_W0_4_DFMT0_LK1(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_LK1_SHIFT)) & XRDC_MDA_W0_4_DFMT0_LK1_MASK)
#define XRDC_MDA_W0_4_DFMT0_VLD_MASK             (0x80000000U)
#define XRDC_MDA_W0_4_DFMT0_VLD_SHIFT            (31U)
#define XRDC_MDA_W0_4_DFMT0_VLD_WIDTH            (1U)
#define XRDC_MDA_W0_4_DFMT0_VLD(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT0_VLD_SHIFT)) & XRDC_MDA_W0_4_DFMT0_VLD_MASK)
/*! @} */
...
/*! @name PDAC_W0 - Peripheral Domain Access Control */
/*! @{ */
...
/*! @name PDAC_W1 - Peripheral Domain Access Control */
/*! @{ */
...
/*! @name XRDC_MRGD_W0 - Memory Region Descriptor */
/*! @{ */
...
/*! @name XRDC_MRGD_W1 - Memory Region Descriptor */
/*! @{ */
...
/*! @name XRDC_MRGD_W2 - Memory Region Descriptor */
/*! @{ */
...
/*! @name XRDC_MRGD_W3 - Memory Region Descriptor */
/*! @{ */
