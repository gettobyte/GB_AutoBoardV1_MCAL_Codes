...
#define CONFIGURATION_GPR_BASE                   (0x4039C000u)
/** Peripheral CONFIGURATION_GPR base pointer */
#define CONFIGURATION_GPR                        ((CONFIGURATION_GPR_Type *)CONFIGURATION_GPR_BASE)
/** Array initializer of CONFIGURATION_GPR peripheral base addresses */
#define CONFIGURATION_GPR_BASE_ADDRS             { CONFIGURATION_GPR_BASE }
/** Array initializer of CONFIGURATION_GPR peripheral base pointers */
#define CONFIGURATION_GPR_BASE_PTRS              { CONFIGURATION_GPR }
