...
typedef struct {
  ...
  __IO uint32_t AMCR;                              /**< Alternate Module Configuration, offset: 0x20 */
  __IO uint32_t AMCRS;                             /**< Alternate Module Configuration Status, offset: 0x24 */
  __I  uint32_t APEADR;                            /**< Alternate Program and Erase Address, offset: 0x28 */
  uint8_t RESERVED_1[4];
  __IO uint32_t ADATA[FLASH_ADATA_COUNT];          /**< Alternate Program Data, array offset: 0x30, array step: 0x4 */
  ...
  __I  uint32_t ASPELOCK;                          /**< Alternate Sector Program and Erase Hardware Lock, offset: 0x60 */
  __I  uint32_t ASSPELOCK;                         /**< Alternate Super Sector Program and Erase Hardware Lock, offset: 0x64 */
...
#define FLASH_INSTANCE_COUNT                     (2u)
...
/** Peripheral FLASH_ALT base address */
#define FLASH_ALT_BASE                           (0x402F0000u)
/** Peripheral FLASH_ALT base pointer */
#define FLASH_ALT                                ((FLASH_Type *)FLASH_ALT_BASE)
/** Array initializer of FLASH peripheral base addresses */
#define FLASH_BASE_ADDRS                         { FLASH_BASE, FLASH_ALT_BASE }
/** Array initializer of FLASH peripheral base pointers */
#define FLASH_BASE_PTRS                          { FLASH, FLASH_ALT }
...
/*! @name AMCR - Alternate Module Configuration */
/*! @{ */
#define FLASH_AMCR_AEHV_MASK                     (0x1U)
#define FLASH_AMCR_AEHV_SHIFT                    (0U)
#define FLASH_AMCR_AEHV_WIDTH                    (1U)
#define FLASH_AMCR_AEHV(x)                       (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_AEHV_SHIFT)) & FLASH_AMCR_AEHV_MASK)
#define FLASH_AMCR_AERS_MASK                     (0x10U)
#define FLASH_AMCR_AERS_SHIFT                    (4U)
#define FLASH_AMCR_AERS_WIDTH                    (1U)
#define FLASH_AMCR_AERS(x)                       (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_AERS_SHIFT)) & FLASH_AMCR_AERS_MASK)
#define FLASH_AMCR_AESS_MASK                     (0x20U)
#define FLASH_AMCR_AESS_SHIFT                    (5U)
#define FLASH_AMCR_AESS_WIDTH                    (1U)
#define FLASH_AMCR_AESS(x)                       (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_AESS_SHIFT)) & FLASH_AMCR_AESS_MASK)
#define FLASH_AMCR_APGM_MASK                     (0x100U)
#define FLASH_AMCR_APGM_SHIFT                    (8U)
#define FLASH_AMCR_APGM_WIDTH                    (1U)
#define FLASH_AMCR_APGM(x)                       (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_APGM_SHIFT)) & FLASH_AMCR_APGM_MASK)
#define FLASH_AMCR_AWDIE_MASK                    (0x1000U)
#define FLASH_AMCR_AWDIE_SHIFT                   (12U)
#define FLASH_AMCR_AWDIE_WIDTH                   (1U)
#define FLASH_AMCR_AWDIE(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_AWDIE_SHIFT)) & FLASH_AMCR_AWDIE_MASK)
#define FLASH_AMCR_APEID_MASK                    (0xFF0000U)
#define FLASH_AMCR_APEID_SHIFT                   (16U)
#define FLASH_AMCR_APEID_WIDTH                   (8U)
#define FLASH_AMCR_APEID(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_APEID_SHIFT)) & FLASH_AMCR_APEID_MASK)
#define FLASH_AMCR_WDD_MASK                      (0x20000000U)
#define FLASH_AMCR_WDD_SHIFT                     (29U)
#define FLASH_AMCR_WDD_WIDTH                     (1U)
#define FLASH_AMCR_WDD(x)                        (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_WDD_SHIFT)) & FLASH_AMCR_WDD_MASK)
#define FLASH_AMCR_WDT_MASK                      (0xC0000000U)
#define FLASH_AMCR_WDT_SHIFT                     (30U)
#define FLASH_AMCR_WDT_WIDTH                     (2U)
#define FLASH_AMCR_WDT(x)                        (((uint32_t)(((uint32_t)(x)) << FLASH_AMCR_WDT_SHIFT)) & FLASH_AMCR_WDT_MASK)
/*! @} */

/*! @name AMCRS - Alternate Module Configuration Status */
/*! @{ */
#define FLASH_AMCRS_ATSPELOCK_MASK               (0x100U)
#define FLASH_AMCRS_ATSPELOCK_SHIFT              (8U)
#define FLASH_AMCRS_ATSPELOCK_WIDTH              (1U)
#define FLASH_AMCRS_ATSPELOCK(x)                 (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_ATSPELOCK_SHIFT)) & FLASH_AMCRS_ATSPELOCK_MASK)
#define FLASH_AMCRS_AEPEG_MASK                   (0x200U)
#define FLASH_AMCRS_AEPEG_SHIFT                  (9U)
#define FLASH_AMCRS_AEPEG_WIDTH                  (1U)
#define FLASH_AMCRS_AEPEG(x)                     (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_AEPEG_SHIFT)) & FLASH_AMCRS_AEPEG_MASK)
#define FLASH_AMCRS_AWDI_MASK                    (0x1000U)
#define FLASH_AMCRS_AWDI_SHIFT                   (12U)
#define FLASH_AMCRS_AWDI_WIDTH                   (1U)
#define FLASH_AMCRS_AWDI(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_AWDI_SHIFT)) & FLASH_AMCRS_AWDI_MASK)
#define FLASH_AMCRS_APEG_MASK                    (0x4000U)
#define FLASH_AMCRS_APEG_SHIFT                   (14U)
#define FLASH_AMCRS_APEG_WIDTH                   (1U)
#define FLASH_AMCRS_APEG(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_APEG_SHIFT)) & FLASH_AMCRS_APEG_MASK)
#define FLASH_AMCRS_ADONE_MASK                   (0x8000U)
#define FLASH_AMCRS_ADONE_SHIFT                  (15U)
#define FLASH_AMCRS_ADONE_WIDTH                  (1U)
#define FLASH_AMCRS_ADONE(x)                     (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_ADONE_SHIFT)) & FLASH_AMCRS_ADONE_MASK)
#define FLASH_AMCRS_APES_MASK                    (0x10000U)
#define FLASH_AMCRS_APES_SHIFT                   (16U)
#define FLASH_AMCRS_APES_WIDTH                   (1U)
#define FLASH_AMCRS_APES(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_APES_SHIFT)) & FLASH_AMCRS_APES_MASK)
#define FLASH_AMCRS_APEP_MASK                    (0x20000U)
#define FLASH_AMCRS_APEP_SHIFT                   (17U)
#define FLASH_AMCRS_APEP_WIDTH                   (1U)
#define FLASH_AMCRS_APEP(x)                      (((uint32_t)(((uint32_t)(x)) << FLASH_AMCRS_APEP_SHIFT)) & FLASH_AMCRS_APEP_MASK)
/*! @} */

/*! @name APEADR - Alternate Program and Erase Address */
/*! @{ */
#define FLASH_APEADR_APEADDR_MASK                (0x7FFF8U)
#define FLASH_APEADR_APEADDR_SHIFT               (3U)
#define FLASH_APEADR_APEADDR_WIDTH               (16U)
#define FLASH_APEADR_APEADDR(x)                  (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEADDR_SHIFT)) & FLASH_APEADR_APEADDR_MASK)
#define FLASH_APEADR_APEA0_MASK                  (0x80000U)
#define FLASH_APEADR_APEA0_SHIFT                 (19U)
#define FLASH_APEADR_APEA0_WIDTH                 (1U)
#define FLASH_APEADR_APEA0(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA0_SHIFT)) & FLASH_APEADR_APEA0_MASK)
#define FLASH_APEADR_APEA1_MASK                  (0x100000U)
#define FLASH_APEADR_APEA1_SHIFT                 (20U)
#define FLASH_APEADR_APEA1_WIDTH                 (1U)
#define FLASH_APEADR_APEA1(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA1_SHIFT)) & FLASH_APEADR_APEA1_MASK)
#define FLASH_APEADR_APEA2_MASK                  (0x200000U)
#define FLASH_APEADR_APEA2_SHIFT                 (21U)
#define FLASH_APEADR_APEA2_WIDTH                 (1U)
#define FLASH_APEADR_APEA2(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA2_SHIFT)) & FLASH_APEADR_APEA2_MASK)
#define FLASH_APEADR_APEA3_MASK                  (0x400000U)
#define FLASH_APEADR_APEA3_SHIFT                 (22U)
#define FLASH_APEADR_APEA3_WIDTH                 (1U)
#define FLASH_APEADR_APEA3(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA3_SHIFT)) & FLASH_APEADR_APEA3_MASK)
#define FLASH_APEADR_APEA4_MASK                  (0x800000U)
#define FLASH_APEADR_APEA4_SHIFT                 (23U)
#define FLASH_APEADR_APEA4_WIDTH                 (1U)
#define FLASH_APEADR_APEA4(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA4_SHIFT)) & FLASH_APEADR_APEA4_MASK)
#define FLASH_APEADR_APEA5_MASK                  (0x1000000U)
#define FLASH_APEADR_APEA5_SHIFT                 (24U)
#define FLASH_APEADR_APEA5_WIDTH                 (1U)
#define FLASH_APEADR_APEA5(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEA5_SHIFT)) & FLASH_APEADR_APEA5_MASK)
#define FLASH_APEADR_APEASAD_MASK                (0x80000000U)
#define FLASH_APEADR_APEASAD_SHIFT               (31U)
#define FLASH_APEADR_APEASAD_WIDTH               (1U)
#define FLASH_APEADR_APEASAD(x)                  (((uint32_t)(((uint32_t)(x)) << FLASH_APEADR_APEASAD_SHIFT)) & FLASH_APEADR_APEASAD_MASK)
/*! @} */

/*! @name ADATA - Alternate Program Data */
/*! @{ */
#define FLASH_ADATA_APDATA_MASK                  (0xFFFFFFFFU)
#define FLASH_ADATA_APDATA_SHIFT                 (0U)
#define FLASH_ADATA_APDATA_WIDTH                 (32U)
#define FLASH_ADATA_APDATA(x)                    (((uint32_t)(((uint32_t)(x)) << FLASH_ADATA_APDATA_SHIFT)) & FLASH_ADATA_APDATA_MASK)
/*! @} */
...
/*! @name ASPELOCK - Alternate Sector Program and Erase Hardware Lock */
/*! @{ */
#define FLASH_ASPELOCK_ASPELOCK_MASK             (0xFFFFFFFFU)
#define FLASH_ASPELOCK_ASPELOCK_SHIFT            (0U)
#define FLASH_ASPELOCK_ASPELOCK_WIDTH            (32U)
#define FLASH_ASPELOCK_ASPELOCK(x)               (((uint32_t)(((uint32_t)(x)) << FLASH_ASPELOCK_ASPELOCK_SHIFT)) & FLASH_ASPELOCK_ASPELOCK_MASK)
/*! @} */

/*! @name ASSPELOCK - Alternate Super Sector Program and Erase Hardware Lock */
/*! @{ */
#define FLASH_ASSPELOCK_ASSPELOCK_MASK           (0xFFFU)
#define FLASH_ASSPELOCK_ASSPELOCK_SHIFT          (0U)
#define FLASH_ASSPELOCK_ASSPELOCK_WIDTH          (12U)
#define FLASH_ASSPELOCK_ASSPELOCK(x)             (((uint32_t)(((uint32_t)(x)) << FLASH_ASSPELOCK_ASSPELOCK_SHIFT)) & FLASH_ASSPELOCK_ASSPELOCK_MASK)
/*! @} */
