...
#define LPSPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C                 4
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_3 =
{
    3U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0u) | LPSPI_CFGR0_HREN(0u) |
             LPSPI_CFGR0_HRSEL(0u) | LPSPI_CFGR0_HRPOL(0u)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U) | LPSPI_CCR_SCKDIV(27U) | LPSPI_CCR_DBT(24U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(0U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(3U) | LPSPI_TCR_CONT(0U)) /* TCR */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_3 =
{
    3U,  /* Instance */
     /* CR */
    (uint32)0,
