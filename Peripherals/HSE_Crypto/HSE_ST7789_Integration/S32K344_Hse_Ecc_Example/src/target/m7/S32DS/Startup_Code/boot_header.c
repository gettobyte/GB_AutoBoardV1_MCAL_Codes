...
extern const uint32_t __APPBL_START;
...
typedef const struct
{
  ...
  const uint32_t* AppBL_StartAddress;
  const uint8_t   Reserved[188];            /* Reserved for future use */
...
#endif
  .Header = 0x5AA55AA5,
  .BootConfig = (1 << 0), /* Booting core is always core CM7 */
