...
*/
#define DioConf_DioPort_PORTE  ((uint8)0x08U)
/**
* @brief          Symbolic name for the channel ST7789_DC.
*
*/
#define DioConf_DioChannel_ST7789_DC  ((uint16)0x008fU)
/* ---------- PORTB ---------- */

/**
* @brief          Symbolic name for the port PORTB.
*/
#define DioConf_DioPort_PORTB  ((uint8)0x02U)
/**
* @brief          Symbolic name for the channel ST7789_CS.
*
*/
#define DioConf_DioChannel_ST7789_CS  ((uint16)0x002cU)
/* ---------- PORTA ---------- */

/**
* @brief          Symbolic name for the port PORTA.
*/
#define DioConf_DioPort_PORTA  ((uint8)0x01U)
/**
* @brief          Symbolic name for the channel ST7789_Reset.
*
*/
#define DioConf_DioChannel_ST7789_Reset  ((uint16)0x0012U)
