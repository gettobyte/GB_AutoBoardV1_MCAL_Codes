...
//
//    Pit_Ip_InitChannel(PIT_0_IP_INSTANCE_NUMBER, PIT_0_ChannelConfig_PB);
//
//    Pit_Ip_EnableChannelInterrupt(PIT_0_IP_INSTANCE_NUMBER, PIT_0_CH_0);
//
//    Pit_Ip_StartChannel(PIT_0_IP_INSTANCE_NUMBER, PIT_0_CH_0PIT_0_CH_0, countValue);
