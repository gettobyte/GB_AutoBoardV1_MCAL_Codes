...
#endif
static void Lpspi_ResetFifo(LPSPI_Type* Base, const Lpspi_Ip_StateStructureType* State, uint32 StatusRegister);
/*==================================================================================================
*                                      LOCAL FUNCTIONS
==================================================================================================*/
/**
...
static void Lpspi_Ip_RepeatedTranserTxHandler(uint8 Instance)
{
    ...
    if(State->DmaRepeatedCallback != NULL_PTR)
    {
        ...
        State->DmaRepeatedCallback(Instance, State->RepeatedTransferAttr);
