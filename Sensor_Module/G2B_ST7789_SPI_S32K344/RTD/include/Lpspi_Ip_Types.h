...
#define LPSPI_IP_TYPES_SW_MAJOR_VERSION             4
...
*
*/
typedef void (*Lpspi_Ip_DmaRepeadtedTransferCallbackType)(uint8 Instance, Lpspi_Ip_RepeatedTransferAttrType* RepeatedTransferAttr);
#endif
#endif
