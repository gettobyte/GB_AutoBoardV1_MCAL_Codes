...
/* Check if Bctu_Ip_Cfg.h file and Bctu_Ip_VS_0_PBcfg.h file are of the same vendor */
#if (BCTU_IP_VENDOR_ID_CFG != BCTU_IP_VENDOR_ID_VS_0_PBCFG)
    #error "Bctu_Ip_Cfg.h and Bctu_Ip_VS_0_PBcfg.h have different vendor ids"
#endif

/* Check if Bctu_Ip_Cfg.h file and Bctu_Ip_VS_0_PBcfg.h file are of the same Autosar version */
#if ((BCTU_IP_AR_RELEASE_MAJOR_VERSION_CFG != BCTU_IP_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG) || \
     (BCTU_IP_AR_RELEASE_MINOR_VERSION_CFG != BCTU_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG) || \
     (BCTU_IP_AR_RELEASE_REVISION_VERSION_CFG != BCTU_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG) \
    )
    #error "AutoSar Version Numbers of Bctu_Ip_Cfg.h and Bctu_Ip_VS_0_PBcfg.h are different"
#endif

/* Check if Bctu_Ip_Cfg.h file and Bctu_Ip_VS_0_PBcfg.h file are of the same Software version */
#if ((BCTU_IP_SW_MAJOR_VERSION_CFG != BCTU_IP_SW_MAJOR_VERSION_VS_0_PBCFG) || \
     (BCTU_IP_SW_MINOR_VERSION_CFG != BCTU_IP_SW_MINOR_VERSION_VS_0_PBCFG) || \
     (BCTU_IP_SW_PATCH_VERSION_CFG != BCTU_IP_SW_PATCH_VERSION_VS_0_PBCFG) \
    )
  #error "Software Version Numbers of Bctu_Ip_Cfg.h and Bctu_Ip_VS_0_PBcfg.h are different"
#endif
