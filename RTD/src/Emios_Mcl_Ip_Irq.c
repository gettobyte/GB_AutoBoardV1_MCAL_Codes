...
#define EMIOS_MCL_IP_IRQ_AR_RELEASE_MINOR_VERSION_C        4
...
ISR(EMIOS0_5_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[0].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[0].S = (Emios_Ip_paxBase[0]->CH.UC[0].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[1].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[1].S = (Emios_Ip_paxBase[0]->CH.UC[1].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[2].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[2].S = (Emios_Ip_paxBase[0]->CH.UC[2].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[3].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[3].S = (Emios_Ip_paxBase[0]->CH.UC[3].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS0_4_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[4].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[4].S = (Emios_Ip_paxBase[0]->CH.UC[4].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[5].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[5].S = (Emios_Ip_paxBase[0]->CH.UC[5].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[6].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[6].S = (Emios_Ip_paxBase[0]->CH.UC[6].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[7].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[7].S = (Emios_Ip_paxBase[0]->CH.UC[7].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS0_3_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[8].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[8].S = (Emios_Ip_paxBase[0]->CH.UC[8].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[9].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[9].S = (Emios_Ip_paxBase[0]->CH.UC[9].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[10].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[10].S = (Emios_Ip_paxBase[0]->CH.UC[10].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[11].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[11].S = (Emios_Ip_paxBase[0]->CH.UC[11].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS0_2_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[12].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[12].S = (Emios_Ip_paxBase[0]->CH.UC[12].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[13].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[13].S = (Emios_Ip_paxBase[0]->CH.UC[13].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[14].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[14].S = (Emios_Ip_paxBase[0]->CH.UC[14].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[15].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[15].S = (Emios_Ip_paxBase[0]->CH.UC[15].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS0_1_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[16].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[16].S = (Emios_Ip_paxBase[0]->CH.UC[16].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[17].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[17].S = (Emios_Ip_paxBase[0]->CH.UC[17].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[18].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[18].S = (Emios_Ip_paxBase[0]->CH.UC[18].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[19].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[19].S = (Emios_Ip_paxBase[0]->CH.UC[19].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS0_0_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[20].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[20].S = (Emios_Ip_paxBase[0]->CH.UC[20].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[21].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[21].S = (Emios_Ip_paxBase[0]->CH.UC[21].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[22].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[22].S = (Emios_Ip_paxBase[0]->CH.UC[22].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[0]->CH.UC[23].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[0]->CH.UC[23].S = (Emios_Ip_paxBase[0]->CH.UC[23].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_5_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[0].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[0].S = (Emios_Ip_paxBase[1]->CH.UC[0].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[1].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[1].S = (Emios_Ip_paxBase[1]->CH.UC[1].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[2].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[2].S = (Emios_Ip_paxBase[1]->CH.UC[2].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[3].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[3].S = (Emios_Ip_paxBase[1]->CH.UC[3].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_4_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[4].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[4].S = (Emios_Ip_paxBase[1]->CH.UC[4].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[5].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[5].S = (Emios_Ip_paxBase[1]->CH.UC[5].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[6].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[6].S = (Emios_Ip_paxBase[1]->CH.UC[6].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[7].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[7].S = (Emios_Ip_paxBase[1]->CH.UC[7].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_3_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[8].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[8].S = (Emios_Ip_paxBase[1]->CH.UC[8].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[9].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[9].S = (Emios_Ip_paxBase[1]->CH.UC[9].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[10].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[10].S = (Emios_Ip_paxBase[1]->CH.UC[10].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[11].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[11].S = (Emios_Ip_paxBase[1]->CH.UC[11].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_2_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[12].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[12].S = (Emios_Ip_paxBase[1]->CH.UC[12].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[13].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[13].S = (Emios_Ip_paxBase[1]->CH.UC[13].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[14].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[14].S = (Emios_Ip_paxBase[1]->CH.UC[14].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[15].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[15].S = (Emios_Ip_paxBase[1]->CH.UC[15].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_1_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[16].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[16].S = (Emios_Ip_paxBase[1]->CH.UC[16].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[17].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[17].S = (Emios_Ip_paxBase[1]->CH.UC[17].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[18].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[18].S = (Emios_Ip_paxBase[1]->CH.UC[18].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[19].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[19].S = (Emios_Ip_paxBase[1]->CH.UC[19].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS1_0_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[20].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[20].S = (Emios_Ip_paxBase[1]->CH.UC[20].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[21].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[21].S = (Emios_Ip_paxBase[1]->CH.UC[21].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[22].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[22].S = (Emios_Ip_paxBase[1]->CH.UC[22].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[1]->CH.UC[23].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[1]->CH.UC[23].S = (Emios_Ip_paxBase[1]->CH.UC[23].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_5_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[0].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[0].S = (Emios_Ip_paxBase[2]->CH.UC[0].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[1].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[1].S = (Emios_Ip_paxBase[2]->CH.UC[1].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[2].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[2].S = (Emios_Ip_paxBase[2]->CH.UC[2].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[3].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[3].S = (Emios_Ip_paxBase[2]->CH.UC[3].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_4_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[4].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[4].S = (Emios_Ip_paxBase[2]->CH.UC[4].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[5].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[5].S = (Emios_Ip_paxBase[2]->CH.UC[5].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[6].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[6].S = (Emios_Ip_paxBase[2]->CH.UC[6].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[7].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[7].S = (Emios_Ip_paxBase[2]->CH.UC[7].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_3_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[8].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[8].S = (Emios_Ip_paxBase[2]->CH.UC[8].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[9].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[9].S = (Emios_Ip_paxBase[2]->CH.UC[9].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[10].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[10].S = (Emios_Ip_paxBase[2]->CH.UC[10].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[11].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[11].S = (Emios_Ip_paxBase[2]->CH.UC[11].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_2_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[12].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[12].S = (Emios_Ip_paxBase[2]->CH.UC[12].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[13].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[13].S = (Emios_Ip_paxBase[2]->CH.UC[13].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[14].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[14].S = (Emios_Ip_paxBase[2]->CH.UC[14].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[15].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[15].S = (Emios_Ip_paxBase[2]->CH.UC[15].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_1_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[16].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[16].S = (Emios_Ip_paxBase[2]->CH.UC[16].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[17].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[17].S = (Emios_Ip_paxBase[2]->CH.UC[17].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[18].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[18].S = (Emios_Ip_paxBase[2]->CH.UC[18].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[19].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[19].S = (Emios_Ip_paxBase[2]->CH.UC[19].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
...
ISR(EMIOS2_0_IRQ)
{
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[20].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[20].S = (Emios_Ip_paxBase[2]->CH.UC[20].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[21].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[21].S = (Emios_Ip_paxBase[2]->CH.UC[21].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[22].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[22].S = (Emios_Ip_paxBase[2]->CH.UC[22].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
    ...
    if ( 0U != ((Emios_Ip_paxBase[2]->CH.UC[23].S) & (uint32)eMIOS_S_FLAG_MASK) )
    {
        ...
        {
            /* Interrupts are not enabled for this channel. Write 1 to clear flags */
            Emios_Ip_paxBase[2]->CH.UC[23].S = (Emios_Ip_paxBase[2]->CH.UC[23].S) & (eMIOS_S_FLAG_MASK | eMIOS_S_OVFL_MASK | eMIOS_S_OVR_MASK);
        }
    }
    #endif
