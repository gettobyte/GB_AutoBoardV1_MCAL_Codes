...
#define EMIOS_PWM_IP_SW_MAJOR_VERSION                2
 ...
 * @param[in] Instance  The eMIOS group id
 * @param[in] Channel   The Channel in this eMIOS group
 * @return uint16 Value of duty cycle
 */
 ...
 * @param[in] Instance   The eMIOS group id
 * @param[in] Channel    The Channel in this eMIOS group
 * @return uint16 Value of leading edge placement in counter bus time base
 */
 ...
 * @param[in] Instance   The eMIOS group id
 * @param[in] Channel    The Channel in this eMIOS group
 * @return uint16 Value of Dead Time
 */
