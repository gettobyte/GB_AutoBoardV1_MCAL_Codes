...
#define EMIOS_PWM_IP_IRQ_AR_RELEASE_MINOR_VERSION     4
#define EMIOS_PWM_IP_IRQ_AR_RELEASE_REVISION_VERSION  0
#define EMIOS_PWM_IP_IRQ_SW_MAJOR_VERSION             2
...
==================================================================================================*/
    ...
    /* Check if header file and StandardTypes.h are of the same AUTOSAR version */
        ...
        #error "AUTOSAR Version Numbers of Emios_Pwm_Ip_Irq.h and StandardTypes.h are different"
    #endif
#endif
