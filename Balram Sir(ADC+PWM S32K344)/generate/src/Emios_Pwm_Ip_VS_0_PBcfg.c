...
#define EMIOS_PWM_IP_VS_0_PB_CFG_AR_RELEASE_MINOR_VERSION_C        4
#define EMIOS_PWM_IP_VS_0_PB_CFG_AR_RELEASE_REVISION_VERSION_C     0
#define EMIOS_PWM_IP_VS_0_PB_CFG_SW_MAJOR_VERSION_C                2
...
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_VS_0_I0_Ch1 =
{
    /* .ChannelId */            1U,
