...
#define BCTU_IP_AR_RELEASE_MINOR_VERSION       4
#define BCTU_IP_AR_RELEASE_REVISION_VERSION    0
#define BCTU_IP_SW_MAJOR_VERSION               2
 ...
 *
 */
#define BCTU_IP_NOTIF_FIFO1                 ((uint32)1U << 0U)
#define BCTU_IP_NOTIF_FIFO2                 ((uint32)1U << 1U)
#define BCTU_IP_NOTIF_ADC0                  ((uint32)1U << 2U) /* These notifications (.._ADCn) affect DATAOVR and NDATA notifications */
#define BCTU_IP_NOTIF_ADC1                  ((uint32)1U << 3U)
#define BCTU_IP_NOTIF_ADC2                  ((uint32)1U << 4U)
#define BCTU_IP_NOTIF_LIST                  ((uint32)1U << 5U) /* This notification affects all ADC instances LIST_LAST notification */
#define BCTU_IP_NOTIF_TRG                   ((uint32)1U << 6U)

#define BCTU_IP_STATUS_TRG                  BCTU_IP_NOTIF_TRG
#define BCTU_IP_STATUS_FIFO1_FULL           ((uint32)1U << 7U)
#define BCTU_IP_STATUS_FIFO2_FULL           ((uint32)1U << 8U)
#define BCTU_IP_STATUS_FIFO1_WM_INT         ((uint32)1U << 9U)
#define BCTU_IP_STATUS_FIFO2_WM_INT         ((uint32)1U << 10U)
#define BCTU_IP_STATUS_FIFO1_OVR_ERR        ((uint32)1U << 11U)
#define BCTU_IP_STATUS_FIFO2_OVR_ERR        ((uint32)1U << 12U)
#define BCTU_IP_STATUS_FIFO1_UNDR_ERR       ((uint32)1U << 13U)
#define BCTU_IP_STATUS_FIFO2_UNDR_ERR       ((uint32)1U << 14U)
#define BCTU_IP_STATUS_ADC0_NDATA           ((uint32)1U << 15U)
#define BCTU_IP_STATUS_ADC1_NDATA           ((uint32)1U << 16U)
#define BCTU_IP_STATUS_ADC2_NDATA           ((uint32)1U << 17U)
#define BCTU_IP_STATUS_ADC0_DATAOVR         ((uint32)1U << 18U)
#define BCTU_IP_STATUS_ADC1_DATAOVR         ((uint32)1U << 19U)
#define BCTU_IP_STATUS_ADC2_DATAOVR         ((uint32)1U << 20U)
#define BCTU_IP_STATUS_ADC0_LAST            ((uint32)1U << 21U)
#define BCTU_IP_STATUS_ADC1_LAST            ((uint32)1U << 22U)
#define BCTU_IP_STATUS_ADC2_LAST            ((uint32)1U << 23U)
