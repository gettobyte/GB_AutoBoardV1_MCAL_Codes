...
#define EMIOS_PWM_IP_HWACCESS_AR_RELEASE_MINOR_VERSION     4
#define EMIOS_PWM_IP_HWACCESS_AR_RELEASE_REVISION_VERSION  0
#define EMIOS_PWM_IP_HWACCESS_SW_MAJOR_VERSION             2
...
==================================================================================================*/
    ...
    /* Check if header file and StandardTypes.h are of the same AUTOSAR version */
        ...
        #error "AUTOSAR Version Numbers of Emios_Pwm_Ip_HwAccess.h and StandardTypes.h are different"
    #endif
#endif
...
/*-----------------------UC register A-----------------------------*/
/*!
 * brief Set A register's Value, maximum Value is 0xFFFF
 * param[in] Base      The Emios Base address pointer
 * param[in] Channel   The Channel id for the given instance
 * param[in] Value     The Value to set
 */
 ...
 */
static inline uint16 Emios_Pwm_Ip_GetUCRegA(const Emios_Pwm_Ip_HwAddrType *const Base,
                                            uint8 Channel)
{
    return (uint16)((Base->CH.UC[Channel].A & eMIOS_A_A_MASK) >> eMIOS_A_A_SHIFT);
}
 ...
 */
static inline uint16 Emios_Pwm_Ip_GetUCRegB(const Emios_Pwm_Ip_HwAddrType *const Base,
                                            uint8 Channel)
{
    return (uint16)((Base->CH.UC[Channel].B & eMIOS_B_B_MASK) >> eMIOS_B_B_SHIFT);
}
 ...
 */
static inline uint16 Emios_Pwm_Ip_GetInternalCounterValue(const Emios_Pwm_Ip_HwAddrType *const Base,
                                                          uint8 Channel)
{
    return (uint16)((Base->CH.UC[Channel].CNT & eMIOS_CNT_C_MASK) >> eMIOS_CNT_C_SHIFT);
}
 ...
 */
static inline uint16 Emios_Pwm_Ip_GetTrigger(const Emios_Pwm_Ip_HwAddrType *const Base,
                                             uint8 Channel)
{
    return (uint16)((Base->CH.UC[Channel].ALTA & eMIOS_ALTA_ALTA_MASK) >> eMIOS_ALTA_ALTA_SHIFT);
}
