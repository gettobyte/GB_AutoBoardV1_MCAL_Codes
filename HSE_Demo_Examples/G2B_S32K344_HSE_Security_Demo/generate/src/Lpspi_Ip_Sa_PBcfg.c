...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_4 =
{
    4U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0u) | LPSPI_CFGR0_HREN(0u) |
             LPSPI_CFGR0_HRSEL(0u) | LPSPI_CFGR0_HRPOL(0u)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U) | LPSPI_CCR_SCKDIV(2U) | LPSPI_CCR_DBT(254U)), /* ccr */
